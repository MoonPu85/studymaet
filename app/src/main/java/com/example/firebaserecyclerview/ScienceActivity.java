...
public class ScienceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scien);



        recyclerView = (RecyclerView) findViewById(R.id.scienrecyclerview); //  아이디 연결
        ...
        databaseReference = database.getReference("sci"); //DB 테이블 연결
